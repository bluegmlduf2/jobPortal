...
function createComment() {
    ...
    $.each(jobCommentList, function (index, value) {
        ...
        listHtml += "<div style='display: inline-block;'>" +
            ...
            "<p><a onclick='javascript:clickReply(this)' href='#leaveCommentHead' class='reply' data-memo='"+JSON.stringify(value)+"'>Reply</a></p>" +
            "</div></br>";
    });
...
function clickReply(param){
    ...
    document.getElementById('leaveComment').innerText="Leave a comment to [ "+pramObj.NM+" ]";
}
