...
module.exports = {
  ...
  getJobCommentList: function (jobNum) {
    return new Promise((resolve, reject) => {
      const con = mysql.createConnection(db);
      var sql = "SELECT JB.JOB_GRP_IDX,JB.JOB_GRP_ORD,JB.JOB_GRP_DEN,JB.JOB_IDX,JB.JOB_WRITER,JB.JOB_TBL_DATE,CONCAT(LPAD('ㄴ',JB.JOB_GRP_DEN*3,' '),JB.JOB_COMMENT) AS JOB_COMMENT_HIE,JOB_COMMENT,\
